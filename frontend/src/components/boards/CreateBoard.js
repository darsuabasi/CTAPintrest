...
//     const createBoard = async (e, downloadToken) => {
//         e.preventDefault();
//         try {
//             let res = await axios({
//                 method: "post",
...
//                     'board_image': `https://firebasestorage.googleapis.com/v0/b/cta-mockpintrest.appspot.com/o/boards/%2F${file.raw.name}?alt=media&token=${downloadToken}`,
//                 },
//                 headers: {
//                     'AuthToken': token,
